...
var PedidosPage = /** @class */ (function () {
    ...
    PedidosPage.prototype.aceitar = function (model) {
        ...
        var pedidosResult = this.http.put(__WEBPACK_IMPORTED_MODULE_1__app_helpers_configHelper__["a" /* ConfigHelper */].Url + "pedido/" + model._id, { _pedido: model.status = "Pedido Aceito" });
    ...
    PedidosPage.prototype.recusar = function (model) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.http.put(__WEBPACK_IMPORTED_MODULE_1__app_helpers_configHelper__["a" /* ConfigHelper */].Url + "pedido/" + model._id, { _pedido: model.status = 'Pedido Recusado' })];
                    case 1:
